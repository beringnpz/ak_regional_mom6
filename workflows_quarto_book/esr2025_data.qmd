...
![Schematic of external forcing used for the MOM6-COBALT-NEP10k near-real-time hindcast extension. (Figure courtesy of Liz Drenkard).](./images/hindcast_forcing_nrt2025b.png){#fig-esr25force}
...
```{bash}
#| file: ./scripts/esr2025_data_extract.sh
#| eval: false
#| code-fold: true
```
