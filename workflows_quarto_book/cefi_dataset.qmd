...
Static variables refer to variables that do not vary over time.  You'll find these variables grouped together in files named "ocean_static" or "ice_static" that are duplicated throughout the CEFI file tree (with usually one copy under each simulation's monthly and daily data folders).
