...
Monthly and daily velocity variables from this simulation were also extracted by request (in July 2026).

```{bash}
#| eval: false
#| code-fold: true
subset_from_archive.sh \
    --region nep \
...
Due to file size, the daily velocity files were reduced to only surface and bottom values (as needed by the end user) for upload to the intermediate data server.  Because this was a one-off request, the file modification was simply run manually as follows, XXXX were all years from 1993 to 2025:

```{bash}
#| eval: false
#| code-fold: true
cdo topvalue    vo.nep.iq0-342jq446-743.hcast.daily.e202604.XXXX0101.nc vos.nep.iq0-342jq446-743.hcast.daily.e202604.XXXX0101.nc
cdo bottomvalue vo.nep.iq0-342jq446-743.hcast.daily.e202604.XXXX0101.nc vob.nep.iq0-342jq446-743.hcast.daily.e202604.XXXX0101.nc
```